...
def main():
    st.title("🧠ParkiC50")
    st.markdown("AI-powered prediction of **pIC₅₀** and bioactivity class for Protein Kinase C targeting drug candidates in Humans against Parkinson's Disease.")
    ...
    st.markdown("---")
    st.markdown("##  ParkiC50 Developers:")
